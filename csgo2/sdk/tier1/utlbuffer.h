...
template <> inline const char *GetFmtStr< unsigned int >	( int nRadix, bool bPrint ) { Assert( nRadix == 10 || nRadix == 16 ); return nRadix == 16 ? "%x" : "%u"; }
template <> inline const char *GetFmtStr< int64_t >	( int nRadix, bool bPrint ) { Assert( nRadix == 10 ); return "%lld"; }
...
inline int64_t CUtlBuffer::Getint64_t( )
{
	int64_t i;
	GetType( i );
	return i;
...
inline void CUtlBuffer::Putint64_t( int64_t i )
{
	PutType( i );
}
